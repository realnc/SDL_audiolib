...
void
Mix_SetPostMix(void (*/*mix_func*/)(void*, Uint8*, int), void* /*arg*/)
{
    AM_debugPrintLn(__func__);
}
...
void
Mix_ChannelFinished(void (*/*channel_finished*/)(int))
{
    AM_debugPrintLn(__func__);
}
...
int
Mix_UnregisterAllEffects(int /*channel*/)
{
    AM_debugPrintLn(__func__);
...
int
Mix_FadeInChannelTimed(int /*channel*/, Mix_Chunk* /*chunk*/, int /*loops*/, int /*ms*/, int /*ticks*/)
{
    AM_debugPrintLn(__func__);
...
int
Mix_FadeOutChannel(int /*which*/, int /*ms*/)
{
    AM_debugPrintLn(__func__);
